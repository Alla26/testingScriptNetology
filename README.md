...
# Сценарии тестов
*для выполнения каждого теста существует предусловие: необходимо переместиться одним из приведенных выше способом на страницу формы записи*
...
4. Ввод в поле Имя кириллицы с дефисом
...
2. Ввод в поле Имя кириллицы 50 символ
...
5. Ввод в поле Имя кириллицы и тегов
   <p>Ввести в поле Имя : Мари>я</p>
* Ожидаемый результат: запрос не обрабатывается, появляется сообщение о том, что в поле имя можно ввести кириллицу, латиницу, дефис, апостороф, Ё

6. Ввод в поле Имя латиницы и тегов
...
1. Ввод в поле Телефон номера телефона через +7
   <p>Ввести в поле Телефон : +79999999999</p>

2. Ввод в поле Телефон номера телефона через 8
   <p>Ввести в поле Телефон : 89999999999</p>

3. Ввод в поле Телефон номера телефона без международного кода
   <p>Ввести в поле Телефон : 9999999999</p>

4. Ввод в поле Телефон номера телефона через дефис
   <p>Ввести в поле Телефон : +7-999-999-99-99</p>

5. Ввод в поле Телефон номера телефона со скобками
   <p>Ввести в поле Телефон : +7(999)9999999</p>

6. Ввод в поле Телефон номера телефона со скобками и дефисами
   <p>Ввести в поле Телефон : +7(999)999-99-99</p>

7. Ввод в поле Телефон номера телефона с пробелами
   <p>Ввести в поле Телефон : +7 999 999 99 99</p>

8. Ввод в поле Телефон номера телефона со скобками, пробелами и дефисами
   <p>Ввести в поле Телефон : +7 (999) 999-99-99</p>

9. Ввод в поле Телефон номера телефона со скобками и пробелами
   <p>Ввести в поле Телефон : +7 (999) 9999999</p>

10. Ввод в поле Телефон номера телефона со пробелами и дефисами
    <p>Ввести в поле Телефон : +7 999-999-99-99</p>
...
3. Ввод в поле Телефон номера телефона с тегом
   <p>Ввести в поле Телефон : +79999999>99</p>
  * Ожидаемый результат: запрос не обрабатывается, появляется сообщение о том, что в поле телефон можно внести только цифры, +, пробел, (), дефис

4. Ввод в поле Телефон номера телефона апострофом
   <p>Ввести в поле Телефон : +79999999'99</p>
  * Ожидаемый результат: запрос не обрабатывается, появляется сообщение о том, что в поле телефон можно внести только цифры, +, пробел, (), дефис

5. Ввод в поле Телефон номера телефона с символом на латинице
   <p>Ввести в поле Телефон : +799F9999999</p>
  * Ожидаемый результат: запрос не обрабатывается, появляется сообщение о том, что в поле телефон можно внести только цифры, +, пробел, (), дефис

6. Ввод в поле Телефон девяти цифр
...
7. Ввод в поле Телефон 50ти цифр
...
1. Ввести в поле Имя невалидное значение
2. Ввести в поле Телефон валидное значение
3. Нажать кнопку Записаться
...
1. Ввести в поле Имя валидное значение
2. Ввести в поле Телефон невалидное значение
3. Нажать кнопку Записаться
